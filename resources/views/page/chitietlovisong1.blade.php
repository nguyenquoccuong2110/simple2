  ...
  <section>
		...
		<div class="contentdetail">
			<h1 class="fullnamepro">
				LÒ VI SÓNG SIMPLEHOME 20MX63-L
			</h1>
			<div class="col_leftpro">
	            ...
	            <div class="list_img_style">
	                <ul class="">
	                  	<li class="item_img click_change_img active_img boxlazy">
	                    	<img class="img_each lazyload" id="01" alt="#" data-src="source/img/20MX63-L-small1.jpg" src="source/img/loader.gif" val="source/img/20MX63-L-big1.jpg" >
	                  	</li>
	                  	<li class="item_img click_change_img boxlazy">
	                    	<img class="img_each lazyload" id="02" alt="#" data-src="source/img/20MX63-L-small2.jpg" src="source/img/loader.gif" val="source/img/20MX63-L-big2.jpg" >
	                  	</li>
	                  	<li class="item_img click_change_img boxlazy">
	                    	<img class="img_each lazyload" id="03" alt="#" data-src="source/img/20MX63-L-small3.jpg" src="source/img/loader.gif" val="source/img/20MX63-L-big3.jpg" >
	                  	</li>
	            ...
	            <div class="img_main">
	                <a href="#" class="zoom_main boxlazy" title="#">
	                    <img class="lazyload" id="zoom_index" alt="#" data-src="source/img/20MX63-L-big1.jpg" src="source/img/loader.gif">
	                </a>
	                <div class="btn_zoom">
          	...
          	<div class="col_rightpro">
          		...
          		<div class="info_general">
          			<p class="info_sap">
						<span>Mã SAP: <b class="sapcode"> 500000410</b></span> <span class="text_margin">|</span>
            	...
            	<div class="box_price pricemarket">
                    ...
                    <span class="price_line">1.690.000 Đ</span>                                                             
				</div>
            	<div class="box_price">
                    <span class="titleprice">Giá bán:</span>
                    <span class="price_sale">1.290.000 Đ</span>                                                             
				</div>
