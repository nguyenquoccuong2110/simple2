  ...
  <section>
		...
		<div class="contentdetail">
			<h1 class="fullnamepro">
				LÒ VI SÓNG SIMPLEHOME 20MG63-L
			</h1>
			<div class="col_leftpro">
	            ...
	            <div class="list_img_style">
	                <ul class="">
	                  	<li class="item_img click_change_img active_img boxlazy">
	                    	<img class="img_each lazyload" id="01" alt="#" data-src="source/img/20MG63-L-small1.png" src="source/img/loader.gif" val="source/img/20MG63-L-big1.png" >
	                  	</li>
	                  	<li class="item_img click_change_img boxlazy">
	                    	<img class="img_each lazyload" id="02" alt="#" data-src="source/img/20MG63-L-small2.png" src="source/img/loader.gif" val="source/img/20MG63-L-big2.png" >
	                  	</li>
	                  	<li class="item_img click_change_img boxlazy">
	                    	<img class="img_each lazyload" id="03" alt="#" data-src="source/img/20MG63-L-small3.png" src="source/img/loader.gif" val="source/img/20MG63-L-big3.png" >
	                  	</li>
	            ...
	            <div class="img_main">
	                <a href="#" class="zoom_main boxlazy" title="#">
	                    <img class="lazyload" id="zoom_index" alt="#" data-src="source/img/20MG63-L-big1.png" src="source/img/loader.gif">
	                </a>
	                <div class="btn_zoom">
          	...
          	<div class="col_rightpro">
          		...
          		<div class="info_general">
          			<p class="info_sap">
						<span>Mã SAP: <b class="sapcode"> 500000411</b></span> <span class="text_margin">|</span>
