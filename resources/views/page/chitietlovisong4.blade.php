  ...
  <section>
		...
		<div class="contentdetail">
			<h1 class="fullnamepro">
				LÒ NƯỚNG KITCHENLUX KWS1538Q-H7
			</h1>
			<div class="col_leftpro">
	            ...
	            <div class="list_img_style">
	                <ul class="">
	                  	<li class="item_img click_change_img active_img boxlazy">
	                    	<img class="img_each lazyload" id="01" alt="#" data-src="source/img/KWS1538Q-H7-small1.png" src="source/img/loader.gif" val="source/img/KWS1538Q-H7-big1.png" >
	                  	</li>	                  		                  	
	            ...
	            <div class="img_main">
	                <a href="#" class="zoom_main boxlazy" title="#">
	                    <img class="lazyload" id="zoom_index" alt="#" data-src="source/img/KWS1538Q-H7-big1.png" src="source/img/loader.gif">
	                </a>
	                <div class="btn_zoom">
          	...
          	<div class="col_rightpro">
          		...
          		<div class="info_general">
          			<p class="info_sap">
						<span>Mã SAP: <b class="sapcode"> 500000321</b></span> <span class="text_margin">|</span>
						<span>Loại: <b class="sapcode">C</b></span>
	            	</p>
            	...
            	<div class="box_price pricemarket">
                    ...
                    <span class="price_line">1.890.000 Đ</span>                                                             
				</div>
            	<div class="box_price">
                    <span class="titleprice">Giá bán:</span>
                    <span class="price_sale">1.490.000 Đ</span>                                                             
				</div>
          		...
          		<div class="box_fulltem">
	          		...
	          		<div class="row_template">
	          			...
	          			<div class="row_table">
	          				...
	          				<div>Nướng các loại thực phẩm như thịt, cá, củ, quả…</div> 
	          			</div>
	          			<div class="row_table">
	          			...
	          			<div class="row_table"> 
	          			 	...
	          			 	<div>Quạt thổi đổi lưu giúp nhiệt lượng tỏa ra đều khắp khoang lò, khiến món nướng trở nên chính đều và ngon hơn</div>
	          			</div> 	          			
	          			<div class="row_table"> 
	          			 	<div>Chức Năng Rã Đông</div> 
	          			 	<div>Có thể tận dụng tính năng làm nóng của lò để rã đông thực phẩm nhanh chóng.</div> 
	          			</div>
	          			<div class="row_table"> 
	          			 	<div>Hẹn Giờ</div>
	          			 	<div>Tối đa 90 phút.</div>
	          			</div> 
	          		</div>
	          		<h3 class="name_property">
	          			Các tiện ích khác
					...
					<h3 class="name_property">
	          		...
	          		<div class="row_template">
						<div class="row_table">
	                        ...
	                        <div>KITCHENLUX ( THƯƠNG HIỆU CAO CẤP )</div>
	                    </div>
	                    <div class="row_table">
	                        <div>Xuất xứ</div>
	                        <div>Trung Quốc</div>
