			...
			<div class="col_leftpro">
	            ...
	            <div class="list_img_style">
	                <ul class="">
	                  	<li class="item_img click_change_img active_img boxlazy">
	                    	<img class="img_each lazyload" id="01" alt="#" data-src="source/img/23UG94-small1.png" src="source/img/loader.gif" val="source/img/23UG94-big1.png" >
	                  	</li>
	                  	<li class="item_img click_change_img boxlazy">
	                    	<img class="img_each lazyload" id="02" alt="#" data-src="source/img/23UG94-small2.png" src="source/img/loader.gif" val="source/img/23UG94-big2.png" >
	                  	</li>	                  	
	            ...
	            <div class="img_main">
	                <a href="#" class="zoom_main boxlazy" title="#">
	                    <img class="lazyload" id="zoom_index" alt="#" data-src="source/img/23UG94-big1.png" src="source/img/loader.gif">
	                </a>
	                <div class="btn_zoom">
          	...
          	<div class="col_rightpro">
          		...
          		<div class="info_general">
          			<p class="info_sap">
						<span>Mã SAP: <b class="sapcode"> 500000413</b></span> <span class="text_margin">|</span>
            	...
            	<div class="box_price pricemarket">
                    ...
                    <span class="price_line">2.290.000 Đ</span>                                                             
				</div>
            	<div class="box_price">
                    <span class="titleprice">Giá bán:</span>
                    <span class="price_sale">1.790.000 Đ</span>                                                             
				</div>
          		...
          		<div class="box_fulltem">
	          		...
	          		<div class="row_template">
	          			...
	          			<div class="row_table">
	          				...
	          				<div>Hoạt động với 10 mức công suất.</div>
	          			</div>
	          			<div class="row_table">
	          		...
	          		<div class="row_template">
	          			<div class="row_table">
	          				...
	          				<div>Nút xoay cơ và phím ấn</div>
	          			</div>
	          			<div class="row_table">
	          				<div>Kiểu Mở Cửa</div>
	          				<div>Tay cầm</div> 
