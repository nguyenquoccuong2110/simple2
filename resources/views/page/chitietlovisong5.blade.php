  ...
  <section>
		...
		<div class="contentdetail">
			<h1 class="fullnamepro">
				VĨ NƯỚNG ĐIỆN SIMPLEHOME DF-608A
			</h1>
			<div class="col_leftpro">
	            ...
	            <div class="list_img_style">
	                <ul class="">
	                  	<li class="item_img click_change_img active_img boxlazy">
	                    	<img class="img_each lazyload" id="01" alt="#" data-src="source/img/DF-608A-small1.png" src="source/img/loader.gif" val="source/img/DF-608A-big1.png" >
	                  	</li>
	                  	<li class="item_img click_change_img active_img boxlazy">
	                    	<img class="img_each lazyload" id="01" alt="#" data-src="source/img/DF-608A-small2.png" src="source/img/loader.gif" val="source/img/DF-608A-big2.png" >
	                  	</li>
	                  	<li class="item_img click_change_img active_img boxlazy">
	                    	<img class="img_each lazyload" id="01" alt="#" data-src="source/img/DF-608A-small3.png" src="source/img/loader.gif" val="source/img/DF-608A-big3.png" >
	                  	</li>
	                  	<li class="item_img click_change_img active_img boxlazy">
	                    	<img class="img_each lazyload" id="01" alt="#" data-src="source/img/DF-608A-small4.png" src="source/img/loader.gif" val="source/img/DF-608A-big4.png" >
	                  	</li>	                  		                  	
	            ...
	            <div class="img_main">
	                <a href="#" class="zoom_main boxlazy" title="#">
	                    <img class="lazyload" id="zoom_index" alt="#" data-src="source/img/DF-608A-big1.png" src="source/img/loader.gif">
	                </a>
	                <div class="btn_zoom">
          	...
          	<div class="col_rightpro">
          		...
          		<div class="info_general">
          			<p class="info_sap">
						<span>Mã SAP: <b class="sapcode"> 500000366</b></span> <span class="text_margin">|</span>
            	...
            	<div class="box_price pricemarket">
                    ...
                    <span class="price_line">990.000 Đ</span>                                                             
				</div>
            	<div class="box_price">
                    <span class="titleprice">Giá bán:</span>
                    <span class="price_sale">799.000 Đ</span>                                                             
				</div>
          		...
          		<div class="box_fulltem">
	          		...
	          		<div class="row_template">
	          			...
	          			<div class="row_table">
	          				...
	          				<div>Nướng Thực Phẩm</div> 
	          			</div>
	          			<div class="row_table">
	          				<div>Tính Năng Khác</div> 
	          				<div>Bề mặt được phủ lớp chống dính / Thiết kế đế nặng, chắc chắn / Các bộ phận có thể tháo rời, vệ sinh dễ dàng.</div> 
	          			</div>
					...
					<h3 class="name_property">
	          		...
	          		<div class="row_template">
						<div class="row_table">
	                        ...
	                        <div>SIMPLEHOME ( THƯƠNG HIỆU CAO CẤP )</div>
	                    </div>
	                    <div class="row_table">
	                        <div>Xuất xứ</div>
	                        <div>Trung Quốc</div>
